...
import os
import json
from serohub_publication.utils import unicode_to_ascii
import argparse

# NOTES
# - extract from 'data/raw/biorxiv/*.json' only the fields required fo
#    training and inference.
# - the output are JSON files with the fields 
#     {"doi": .., "source": "biorxiv", "text": ..}
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-r", "--RAWFILEPATH", type=str, default="data/raw/biorxiv",
        ...
        if not (FILENAME in set_filenames):
            ...
            with open(raw_filepaths[i], "r") as fptr:
                ...
                doc2 = {
                    "source": "biorxiv",
                    "doi": doc['rel_doi'],
                    "text": unicode_to_ascii(
                        f"{doc['rel_title']}. {doc['rel_abs']}")}
